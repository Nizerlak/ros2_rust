...
/// A message that is owned by the middleware.
///
/// It dereferences to a `&mut T`.
///
/// By being owned by the middleware, it can be placed in the shared memory between publisher and
/// subscriber, if that is supported by the middleware.
